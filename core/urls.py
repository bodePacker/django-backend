...
from .views import get_user_profile_data, get_user_mappings, create_mapping, delete_mapping, CustomTokenObtainParView, CustomTokenRefreshView, register, authenticated, get_all_community_mappings, join_waitlist, get_specific_mapping, add_tags, rename_mapping
app_name = 'core'
